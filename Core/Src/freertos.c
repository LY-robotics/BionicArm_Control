...
#include "spi.h"
#include "usart.h"
#include "../App/integration/sanpo_app.h"
#include "i2c.h"
#include "adc.h"
#include "mpu6050.h"
#include "usart.h"
...
* The original remove_me() placeholder must not be called here because the
* SANPO application service loop below now contains real application code.
* ********************************************************/
